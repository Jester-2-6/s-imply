...
import unittest
from src.atpg.reconv_podem import get_lrr, identify_exit_lines, pick_reconv_pair, PathConsistencySolver, RecursiveStructureSolver
...
class TestMaamariLogic(unittest.TestCase):
    ...
    def test_heuristic_scoring(self):
        ...
        # Let's create a circuit where one path is tight and one is leaky and see if we pick the tight one?
